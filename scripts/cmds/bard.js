...
async function onStart({ api, event }) {
    ...
    try {
        const apiBaseUrl = 'https://api.elianabot.xyz';
...
// // Dummy function for convertImageToText, replace with actual implementation
// async function convertImageToText(imageURL) {
//     // Implementation to convert image to text
//     // This is a placeholder and should be replaced with actual image to text conversion code
